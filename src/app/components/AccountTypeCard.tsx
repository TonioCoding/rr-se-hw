  ...
  return (
    <IconContext.Provider value={{ size: "3rem", className: "self-center" }}>
      <Card
        ...
        className="hover:cursor-pointer w-[300px] transtion-all ease-in-out duration-300 hover:bg-gray-300 border border-gray-600 text-center flex flex-col gap-[1rem] items-center place-content-center p-4"
      >
